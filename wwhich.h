...
#define WWHICH_PATCH_VERSION  2
#if defined(BUILD_NUMBER)
# define WWHICH_MICRO_VERSION BUILD_NUMBER
#else
...
# define WWHICH_VENDOR_SFX      CPP_TOSTR(BUILD_VENDOR)
#else
...
#define WwHICH_VERSION_ALL      WwHICH_VERSION                             \
                                WwHICH_VENDOR_STR

#define WWHICH_VERSION          WWHICH_VERSION_STR "."                     \
                                CPP_TOSTR(WWHICH_MICRO_VERSION)
...
#define WWHICH_COPYRIGHT       "Copyright (c) 1964-2024 The Acme Corporation or its licensors, as applicable"
#define WWHICH_LICENSE_SHORT   "Licensed under the Apache-2.0 License"
